...
const TodayManifest = () => {
  ...
  // }
  const loading = () => (
    <div className="animated fadeIn pt-1 text-center mt-5">fff...</div>
  );
  useEffect(() => {
    getTodayManifest();
  }, []);
  const getTodayManifest = () => {
    ...
    axios
      ...
      .then((res) => {
        ...
        let response = res.data.response.data.manifestsToday;
    ...
    <>
      <div className="row">
        <div className="col-sm-12 col-md-12 col-lg-12 col-12">
          <h2 className="text-danger">Today Manifest</h2>
        </div>
        ...
        <div className="col-sm-12 col-md-6 col-lg-3 w-5">
          <input
            type="text"
            style={{
              borderColor: "rgb(149, 0, 20)",
              ...
              <>
                <div className="col-sm-12 col-md-6 col-lg-3  ">
                  <div className="v-list-item__title fontColor text-left align-self-center text-wrap">
                    ...
                    <h6 className="subtitle"> {item.finalCheckBy} </h6>
                ...
                <div className="col-sm-12 col-md-6 col-lg-3 ">
                  <div class="v-list-item__title text-left">
                    <h6 class="subtitle-2 black--text">
                      <span>Manifest No:</span>
                      {item.serialNo}{" "}
                    </h6>
                    <h6 class="subtitle-2 font-weight-light black--text">
                      {" "}
                    ...
                    <h6 class="subtitle-2 green--text text-green darken-2">
                      {" "}
                      Amount:{" "}
                    </h6>
                  </div>
